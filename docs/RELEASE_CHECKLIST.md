...
- Run `python -m ruff check phantom_flow tests`.
- Run the deterministic public scenario smoke and verify `scenario-summary.json`, run artifacts, and no `context` leakage.
