...
- Package metadata classifiers, project URLs, and `dev` verification extra for CI.
- CI wheel build, core engine lint, deterministic public scenario smoke, and release-prep gate.
...
- Release candidate approved for public source publication as `v0.1.0-alpha.0`.
